...
function App() {
  const [coordinates, setCoords] = useState<Coords>({ lat: 23.8103, lon: 90.4125 })
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 pt-3 p-4 xs:pt-4 lg:w-[calc(100dvw-var(--sidebar-width))] 2xl:h-screen 2xl:min-h-[900px]">
        ...
        <div className="grid grid-cols-1 2xl:flex-1 2xl:min-h-0 md:grid-cols-2 2xl:grid-cols-4 2xl:grid-rows-4 gap-3">
          <div className="relative h-80 2xl:h-auto col-span-1 md:col-span-2 2xl:col-span-4 2xl:row-span-2 order-1">
