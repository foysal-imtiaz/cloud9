...
export default function SidePanel(props: Props) {
  ...
  return (
    <div
      className={clsx(
        "fixed top-0 right-0 h-screen w-(--sidebar-width) shadow-md bg-sidebar z-1001 py-4 px-3 overflow-y-scroll transition-transform duration-300 lg:translate-x-0!",
        isSidePanelOpen ? "translate-x-0" : "translate-x-full"
      )}
    >
      <button onClick={() => setIsSidePanelOpen(false)}>
        <Chevron className="size-6 -ml-2 lg:hidden" />
      </button>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className={clsx(
            ...
            data.list[0].main.aqi === 2 && "bg-yellow-500",
            data.list[0].main.aqi === 3 && "bg-orange-500",
            data.list[0].main.aqi === 4 && "bg-red-500",
            data.list[0].main.aqi === 5 && "bg-purple-500"
          )}>
